---
doc_id: hard-negative-hn-fastapi-0018-b
title: 'Hard Negative HN-FASTAPI-0018 B: Body - Nested Models { #body-nested-models
  }'
doc_type: public_doc
status: active
...
tags:
- fastapi
- 013-tutorial-body-nested-models
language: en
source_path: data/hard_negative_corpus/hn-fastapi-0018/b-013-tutorial-body-nested-models.md
...
hard_negative_group_id: hn-fastapi-0018
metadata_origin: native
source_url: https://raw.githubusercontent.com/fastapi/fastapi/master/docs/en/docs/tutorial/body-nested-models.md
upstream_repo_path: docs/en/docs/tutorial/body-nested-models.md
---
