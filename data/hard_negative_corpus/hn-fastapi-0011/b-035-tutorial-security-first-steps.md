---
doc_id: hard-negative-hn-fastapi-0011-b
title: 'Hard Negative HN-FASTAPI-0011 B: Security - First Steps { #security-first-steps
  }'
doc_type: public_doc
status: active
...
tags:
- fastapi
- 035-tutorial-security-first-steps
language: en
source_path: data/hard_negative_corpus/hn-fastapi-0011/b-035-tutorial-security-first-steps.md
...
hard_negative_group_id: hn-fastapi-0011
metadata_origin: native
source_url: https://raw.githubusercontent.com/fastapi/fastapi/master/docs/en/docs/tutorial/security/first-steps.md
upstream_repo_path: docs/en/docs/tutorial/security/first-steps.md
---
