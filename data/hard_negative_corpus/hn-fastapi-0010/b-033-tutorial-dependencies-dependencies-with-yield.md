---
doc_id: hard-negative-hn-fastapi-0010-b
title: 'Hard Negative HN-FASTAPI-0010 B: Dependencies with yield { #dependencies-with-yield
  }'
doc_type: public_doc
status: active
...
tags:
- fastapi
- 033-tutorial-dependencies-dependencies-with-yield
language: en
source_path: data/hard_negative_corpus/hn-fastapi-0010/b-033-tutorial-dependencies-dependencies-with-yield.md
...
hard_negative_group_id: hn-fastapi-0010
metadata_origin: native
source_url: https://raw.githubusercontent.com/fastapi/fastapi/master/docs/en/docs/tutorial/dependencies/dependencies-with-yield.md
upstream_repo_path: docs/en/docs/tutorial/dependencies/dependencies-with-yield.md
---
