---
doc_id: hard-negative-hn-fastapi-0014-a
title: 'Hard Negative HN-FASTAPI-0014 A: CORS (Cross-Origin Resource Sharing) { #cors-cross-origin-resource-sharing
  }'
doc_type: public_doc
status: active
...
- 040-tutorial-cors
language: en
source_path: data/hard_negative_corpus/hn-fastapi-0014/a-040-tutorial-cors.md
...
hard_negative_group_id: hn-fastapi-0014
metadata_origin: native
source_url: https://raw.githubusercontent.com/fastapi/fastapi/master/docs/en/docs/tutorial/cors.md
upstream_repo_path: docs/en/docs/tutorial/cors.md
---
