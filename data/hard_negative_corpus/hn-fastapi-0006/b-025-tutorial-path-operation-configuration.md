---
doc_id: hard-negative-hn-fastapi-0006-b
title: 'Hard Negative HN-FASTAPI-0006 B: Path Operation Configuration { #path-operation-configuration
  }'
doc_type: public_doc
status: active
...
tags:
- fastapi
- 025-tutorial-path-operation-configuration
language: en
source_path: data/hard_negative_corpus/hn-fastapi-0006/b-025-tutorial-path-operation-configuration.md
...
hard_negative_group_id: hn-fastapi-0006
metadata_origin: native
source_url: https://raw.githubusercontent.com/fastapi/fastapi/master/docs/en/docs/tutorial/path-operation-configuration.md
upstream_repo_path: docs/en/docs/tutorial/path-operation-configuration.md
---
