---
doc_id: hard-negative-hn-fastapi-0006-a
title: 'Hard Negative HN-FASTAPI-0006 A: Handling Errors { #handling-errors }'
doc_type: public_doc
status: active
...
tags:
- fastapi
- 024-tutorial-handling-errors
language: en
source_path: data/hard_negative_corpus/hn-fastapi-0006/a-024-tutorial-handling-errors.md
...
source_url: https://raw.githubusercontent.com/fastapi/fastapi/master/docs/en/docs/tutorial/handling-errors.md
upstream_repo_path: docs/en/docs/tutorial/handling-errors.md
---
