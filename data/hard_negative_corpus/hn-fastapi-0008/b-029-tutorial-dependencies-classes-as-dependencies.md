---
doc_id: hard-negative-hn-fastapi-0008-b
title: 'Hard Negative HN-FASTAPI-0008 B: Classes as Dependencies { #classes-as-dependencies
  }'
doc_type: public_doc
status: active
...
tags:
- fastapi
- 029-tutorial-dependencies-classes-as-dependencies
language: en
source_path: data/hard_negative_corpus/hn-fastapi-0008/b-029-tutorial-dependencies-classes-as-dependencies.md
...
hard_negative_group_id: hn-fastapi-0008
metadata_origin: native
source_url: https://raw.githubusercontent.com/fastapi/fastapi/master/docs/en/docs/tutorial/dependencies/classes-as-dependencies.md
upstream_repo_path: docs/en/docs/tutorial/dependencies/classes-as-dependencies.md
---
