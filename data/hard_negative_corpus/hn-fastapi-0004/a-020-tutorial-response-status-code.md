---
doc_id: hard-negative-hn-fastapi-0004-a
title: 'Hard Negative HN-FASTAPI-0004 A: Response Status Code { #response-status-code
  }'
doc_type: public_doc
status: active
...
tags:
- fastapi
- 020-tutorial-response-status-code
language: en
source_path: data/hard_negative_corpus/hn-fastapi-0004/a-020-tutorial-response-status-code.md
...
source_url: https://raw.githubusercontent.com/fastapi/fastapi/master/docs/en/docs/tutorial/response-status-code.md
upstream_repo_path: docs/en/docs/tutorial/response-status-code.md
---
