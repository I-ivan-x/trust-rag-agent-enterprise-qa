---
doc_id: hard-negative-hn-fastapi-0007-b
title: 'Hard Negative HN-FASTAPI-0007 B: Body - Updates { #body-updates }'
doc_type: public_doc
status: active
...
tags:
- fastapi
- 027-tutorial-body-updates
language: en
source_path: data/hard_negative_corpus/hn-fastapi-0007/b-027-tutorial-body-updates.md
...
source_url: https://raw.githubusercontent.com/fastapi/fastapi/master/docs/en/docs/tutorial/body-updates.md
upstream_repo_path: docs/en/docs/tutorial/body-updates.md
---
