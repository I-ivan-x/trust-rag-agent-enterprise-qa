---
doc_id: hard-negative-hn-fastapi-0007-a
title: 'Hard Negative HN-FASTAPI-0007 A: JSON Compatible Encoder { #json-compatible-encoder
  }'
doc_type: public_doc
status: active
...
tags:
- fastapi
- 026-tutorial-encoder
language: en
source_path: data/hard_negative_corpus/hn-fastapi-0007/a-026-tutorial-encoder.md
...
hard_negative_group_id: hn-fastapi-0007
metadata_origin: native
source_url: https://raw.githubusercontent.com/fastapi/fastapi/master/docs/en/docs/tutorial/encoder.md
upstream_repo_path: docs/en/docs/tutorial/encoder.md
---
