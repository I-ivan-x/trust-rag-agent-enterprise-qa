---
doc_id: hard-negative-hn-fastapi-0019-b
title: 'Hard Negative HN-FASTAPI-0019 B: Features { #features }'
doc_type: public_doc
status: active
...
- 002-features
language: en
source_path: data/hard_negative_corpus/hn-fastapi-0019/b-002-features.md
...
hard_negative_group_id: hn-fastapi-0019
metadata_origin: native
source_url: https://raw.githubusercontent.com/fastapi/fastapi/master/docs/en/docs/features.md
upstream_repo_path: docs/en/docs/features.md
---
