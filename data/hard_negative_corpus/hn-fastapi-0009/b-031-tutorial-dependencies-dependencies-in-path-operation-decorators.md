---
doc_id: hard-negative-hn-fastapi-0009-b
title: 'Hard Negative HN-FASTAPI-0009 B: Dependencies in path operation decorators
...
tags:
- fastapi
- 031-tutorial-dependencies-dependencies-in-path-operation-decorators
language: en
source_path: data/hard_negative_corpus/hn-fastapi-0009/b-031-tutorial-dependencies-dependencies-in-path-operation-decorators.md
...
hard_negative_group_id: hn-fastapi-0009
metadata_origin: native
source_url: https://raw.githubusercontent.com/fastapi/fastapi/master/docs/en/docs/tutorial/dependencies/dependencies-in-path-operation-decorators.md
upstream_repo_path: docs/en/docs/tutorial/dependencies/dependencies-in-path-operation-decorators.md
---
