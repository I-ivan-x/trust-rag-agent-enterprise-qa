---
doc_id: hard-negative-hn-fastapi-0003-a
title: 'Hard Negative HN-FASTAPI-0003 A: Response Model - Return Type { #response-model-return-type
  }'
doc_type: public_doc
status: active
...
tags:
- fastapi
- 018-tutorial-response-model
language: en
source_path: data/hard_negative_corpus/hn-fastapi-0003/a-018-tutorial-response-model.md
...
hard_negative_group_id: hn-fastapi-0003
metadata_origin: native
source_url: https://raw.githubusercontent.com/fastapi/fastapi/master/docs/en/docs/tutorial/response-model.md
upstream_repo_path: docs/en/docs/tutorial/response-model.md
---
