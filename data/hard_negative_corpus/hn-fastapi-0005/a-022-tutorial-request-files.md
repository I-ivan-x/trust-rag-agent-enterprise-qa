---
doc_id: hard-negative-hn-fastapi-0005-a
title: 'Hard Negative HN-FASTAPI-0005 A: Request Files { #request-files }'
doc_type: public_doc
status: active
...
tags:
- fastapi
- 022-tutorial-request-files
language: en
source_path: data/hard_negative_corpus/hn-fastapi-0005/a-022-tutorial-request-files.md
...
hard_negative_group_id: hn-fastapi-0005
metadata_origin: native
source_url: https://raw.githubusercontent.com/fastapi/fastapi/master/docs/en/docs/tutorial/request-files.md
upstream_repo_path: docs/en/docs/tutorial/request-files.md
---
