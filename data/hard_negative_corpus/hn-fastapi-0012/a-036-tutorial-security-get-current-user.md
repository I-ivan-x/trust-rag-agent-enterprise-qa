---
doc_id: hard-negative-hn-fastapi-0012-a
title: 'Hard Negative HN-FASTAPI-0012 A: Get Current User { #get-current-user }'
doc_type: public_doc
status: active
...
tags:
- fastapi
- 036-tutorial-security-get-current-user
language: en
source_path: data/hard_negative_corpus/hn-fastapi-0012/a-036-tutorial-security-get-current-user.md
...
hard_negative_group_id: hn-fastapi-0012
metadata_origin: native
source_url: https://raw.githubusercontent.com/fastapi/fastapi/master/docs/en/docs/tutorial/security/get-current-user.md
upstream_repo_path: docs/en/docs/tutorial/security/get-current-user.md
---
