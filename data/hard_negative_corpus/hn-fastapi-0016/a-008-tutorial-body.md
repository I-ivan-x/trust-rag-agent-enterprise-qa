---
doc_id: hard-negative-hn-fastapi-0016-a
title: 'Hard Negative HN-FASTAPI-0016 A: Request Body { #request-body }'
doc_type: public_doc
status: active
...
- 008-tutorial-body
language: en
source_path: data/hard_negative_corpus/hn-fastapi-0016/a-008-tutorial-body.md
...
source_url: https://raw.githubusercontent.com/fastapi/fastapi/master/docs/en/docs/tutorial/body.md
upstream_repo_path: docs/en/docs/tutorial/body.md
---
