---
doc_id: hard-negative-hn-fastapi-0017-b
title: 'Hard Negative HN-FASTAPI-0017 B: Body - Multiple Parameters { #body-multiple-parameters
  }'
doc_type: public_doc
status: active
...
tags:
- fastapi
- 011-tutorial-body-multiple-params
language: en
source_path: data/hard_negative_corpus/hn-fastapi-0017/b-011-tutorial-body-multiple-params.md
...
source_url: https://raw.githubusercontent.com/fastapi/fastapi/master/docs/en/docs/tutorial/body-multiple-params.md
upstream_repo_path: docs/en/docs/tutorial/body-multiple-params.md
---
