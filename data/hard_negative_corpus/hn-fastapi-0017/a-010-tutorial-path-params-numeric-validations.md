---
doc_id: hard-negative-hn-fastapi-0017-a
title: 'Hard Negative HN-FASTAPI-0017 A: Path Parameters and Numeric Validations {
...
tags:
- fastapi
- 010-tutorial-path-params-numeric-validations
language: en
source_path: data/hard_negative_corpus/hn-fastapi-0017/a-010-tutorial-path-params-numeric-validations.md
...
hard_negative_group_id: hn-fastapi-0017
metadata_origin: native
source_url: https://raw.githubusercontent.com/fastapi/fastapi/master/docs/en/docs/tutorial/path-params-numeric-validations.md
upstream_repo_path: docs/en/docs/tutorial/path-params-numeric-validations.md
---
