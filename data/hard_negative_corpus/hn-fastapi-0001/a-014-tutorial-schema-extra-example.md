---
doc_id: hard-negative-hn-fastapi-0001-a
title: 'Hard Negative HN-FASTAPI-0001 A: Declare Request Example Data { #declare-request-example-data
  }'
doc_type: public_doc
status: active
...
tags:
- fastapi
- 014-tutorial-schema-extra-example
language: en
source_path: data/hard_negative_corpus/hn-fastapi-0001/a-014-tutorial-schema-extra-example.md
...
hard_negative_group_id: hn-fastapi-0001
metadata_origin: native
source_url: https://raw.githubusercontent.com/fastapi/fastapi/master/docs/en/docs/tutorial/schema-extra-example.md
upstream_repo_path: docs/en/docs/tutorial/schema-extra-example.md
---
