---
doc_id: hard-negative-hn-fastapi-0015-a
title: 'Hard Negative HN-FASTAPI-0015 A: Path Parameters { #path-parameters }'
doc_type: public_doc
status: active
...
tags:
- fastapi
- 006-tutorial-path-params
language: en
source_path: data/hard_negative_corpus/hn-fastapi-0015/a-006-tutorial-path-params.md
...
source_url: https://raw.githubusercontent.com/fastapi/fastapi/master/docs/en/docs/tutorial/path-params.md
upstream_repo_path: docs/en/docs/tutorial/path-params.md
---
