---
doc_id: hard-negative-hn-fastapi-0013-a
title: 'Hard Negative HN-FASTAPI-0013 A: OAuth2 with Password (and hashing), Bearer
  with JWT tokens { #oauth2-with-password-and-hashing-bearer-with-jwt-tokens }'
doc_type: public_doc
status: active
...
tags:
- fastapi
- 038-tutorial-security-oauth2-jwt
language: en
source_path: data/hard_negative_corpus/hn-fastapi-0013/a-038-tutorial-security-oauth2-jwt.md
...
hard_negative_group_id: hn-fastapi-0013
metadata_origin: native
source_url: https://raw.githubusercontent.com/fastapi/fastapi/master/docs/en/docs/tutorial/security/oauth2-jwt.md
upstream_repo_path: docs/en/docs/tutorial/security/oauth2-jwt.md
---
