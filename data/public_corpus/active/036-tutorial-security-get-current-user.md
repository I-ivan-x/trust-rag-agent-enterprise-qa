---
doc_id: doc-public-fastapi-0036-get-current-user-get-current-user
title: 'Get Current User { #get-current-user }'
doc_type: public_doc
status: active
...
language: en
source_path: data/public_corpus/active/036-tutorial-security-get-current-user.md
