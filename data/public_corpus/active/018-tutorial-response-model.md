---
doc_id: doc-public-fastapi-0018-response-model-return-type-response-model-return
title: 'Response Model - Return Type { #response-model-return-type }'
doc_type: public_doc
status: active
...
language: en
source_path: data/public_corpus/active/018-tutorial-response-model.md
