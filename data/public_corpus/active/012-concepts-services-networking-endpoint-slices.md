---
doc_id: doc-public-k8s-0012-concepts-services-networking-endpoint-slices
title: Concepts - Services-Networking - Endpoint-Slices
doc_type: public_doc
status: active
...
- stale_procedure
language: en
source_path: data/public_corpus/active/012-concepts-services-networking-endpoint-slices.md
...
source_url: https://raw.githubusercontent.com/kubernetes/website/main/content/en/docs/concepts/services-networking/endpoint-slices.md
upstream_repo_path: content/en/docs/concepts/services-networking/endpoint-slices.md
upstream_original_path: content/en/docs/concepts/services-networking/endpoint-slices.md
upstream_ref: main
