---
doc_id: doc-public-k8s-0015-tasks-manage-daemon-update-daemon-set
title: Tasks - Manage-Daemon - Update-Daemon-Set
doc_type: public_doc
status: active
...
- missing_prereq
language: en
source_path: data/public_corpus/active/015-tasks-manage-daemon-update-daemon-set.md
...
source_url: https://raw.githubusercontent.com/kubernetes/website/main/content/en/docs/tasks/manage-daemon/update-daemon-set.md
upstream_repo_path: content/en/docs/tasks/manage-daemon/update-daemon-set.md
upstream_original_path: content/en/docs/tasks/manage-daemon/update-daemon-set.md
upstream_ref: main
q3_condition_hint: no_op,MISSING_PREREQ
---
