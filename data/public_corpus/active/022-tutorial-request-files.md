---
doc_id: doc-public-fastapi-0022-request-files-request-files
title: 'Request Files { #request-files }'
doc_type: public_doc
status: active
...
language: en
source_path: data/public_corpus/active/022-tutorial-request-files.md
