---
doc_id: doc-public-k8s-0001-reference-using-api-deprecation-policy
title: Reference - Using-Api - Deprecation-Policy
doc_type: public_doc
status: active
...
- stale_procedure
language: en
source_path: data/public_corpus/active/001-reference-using-api-deprecation-policy.md
...
source_url: https://raw.githubusercontent.com/kubernetes/website/main/content/en/docs/reference/using-api/deprecation-policy.md
upstream_repo_path: content/en/docs/reference/using-api/deprecation-policy.md
upstream_original_path: content/en/docs/reference/using-api/deprecation-policy.md
upstream_ref: main
