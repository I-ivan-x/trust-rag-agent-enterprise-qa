---
doc_id: doc-public-fastapi-0014-declare-request-example-data-declare-request-exa
title: 'Declare Request Example Data { #declare-request-example-data }'
doc_type: public_doc
status: active
...
language: en
source_path: data/public_corpus/active/014-tutorial-schema-extra-example.md
