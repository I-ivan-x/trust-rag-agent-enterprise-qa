---
doc_id: doc-public-k8s-0002-reference-using-api-deprecation-guide
title: Reference - Using-Api - Deprecation-Guide
doc_type: public_doc
status: active
...
- stale_procedure
language: en
source_path: data/public_corpus/active/002-reference-using-api-deprecation-guide.md
...
source_url: https://raw.githubusercontent.com/kubernetes/website/main/content/en/docs/reference/using-api/deprecation-guide.md
upstream_repo_path: content/en/docs/reference/using-api/deprecation-guide.md
upstream_original_path: content/en/docs/reference/using-api/deprecation-guide.md
upstream_ref: main
