---
doc_id: doc-public-fastapi-0020-response-status-code-response-status-code
title: 'Response Status Code { #response-status-code }'
doc_type: public_doc
status: active
...
language: en
source_path: data/public_corpus/active/020-tutorial-response-status-code.md
