---
doc_id: doc-public-k8s-0003-the-per-mode-level-label-indicates-which-policy-
title: The per-mode level label indicates which policy level to apply for the mode.
doc_type: public_doc
status: active
...
- config_violation
language: en
source_path: data/public_corpus/active/003-concepts-security-pod-security-admission.md
...
source_url: https://raw.githubusercontent.com/kubernetes/website/main/content/en/docs/concepts/security/pod-security-admission.md
upstream_repo_path: content/en/docs/concepts/security/pod-security-admission.md
upstream_original_path: content/en/docs/concepts/security/pod-security-admission.md
upstream_ref: main
q3_condition_hint: STALE_PROCEDURE,CONFIG_VIOLATION
---
