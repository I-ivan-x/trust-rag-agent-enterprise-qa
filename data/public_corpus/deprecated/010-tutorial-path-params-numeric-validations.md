---
doc_id: doc-public-fastapi-0010-path-parameters-and-numeric-validations-path-par
title: 'Path Parameters and Numeric Validations { #path-parameters-and-numeric-validations
  }'
doc_type: public_doc
status: active
...
language: en
source_path: data/public_corpus/deprecated/010-tutorial-path-params-numeric-validations.md
