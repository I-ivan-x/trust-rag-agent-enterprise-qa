---
doc_id: doc-public-k8s-0021-authorize-all-service-accounts-in-a-namespace-re
title: 'Authorize all service accounts in a namespace (recommended):'
doc_type: public_doc
status: deprecated
...
- stale_procedure
language: en
source_path: data/public_corpus/deprecated/021-concepts-security-pod-security-policy.md
...
source_url: https://raw.githubusercontent.com/kubernetes/website/release-1.24/content/en/docs/concepts/security/pod-security-policy.md
upstream_repo_path: content/en/docs/concepts/security/pod-security-policy.md
upstream_original_path: content/en/docs/concepts/security/pod-security-policy.md
upstream_ref: release-1.24
