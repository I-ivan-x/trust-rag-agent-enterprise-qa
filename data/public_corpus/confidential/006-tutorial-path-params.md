---
doc_id: doc-public-fastapi-0006-path-parameters-path-parameters
title: 'Path Parameters { #path-parameters }'
doc_type: public_doc
status: active
...
language: en
source_path: data/public_corpus/confidential/006-tutorial-path-params.md
