---
doc_id: doc-public-k8s-0004-concepts-security-pod-security-standards
title: Concepts - Security - Pod-Security-Standards
doc_type: public_doc
status: active
...
- config_violation
language: en
source_path: data/public_corpus/security/004-concepts-security-pod-security-standards.md
...
source_url: https://raw.githubusercontent.com/kubernetes/website/main/content/en/docs/concepts/security/pod-security-standards.md
upstream_repo_path: content/en/docs/concepts/security/pod-security-standards.md
upstream_original_path: content/en/docs/concepts/security/pod-security-standards.md
upstream_ref: main
