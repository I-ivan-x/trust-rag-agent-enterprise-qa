---
doc_id: doc-public-k8s-0006-tasks-configure-pod-container-enforce-standards-
title: Tasks - Configure-Pod-Container - Enforce-Standards-Namespace-Labels
doc_type: public_doc
status: active
...
- config_violation
language: en
source_path: data/public_corpus/security/006-tasks-configure-pod-container-enforce-standards-namespace-labels.md
...
source_url: https://raw.githubusercontent.com/kubernetes/website/main/content/en/docs/tasks/configure-pod-container/enforce-standards-namespace-labels.md
upstream_repo_path: content/en/docs/tasks/configure-pod-container/enforce-standards-namespace-labels.md
upstream_original_path: content/en/docs/tasks/configure-pod-container/enforce-standards-namespace-labels.md
upstream_ref: main
