---
doc_id: doc-public-k8s-0009-when-you-create-the-monitoring-endpointslices-cl
title: When you create the "monitoring-endpointslices" ClusterRole,
doc_type: public_doc
status: active
...
- permission_blocked
language: en
source_path: data/public_corpus/security/009-reference-access-authn-authz-rbac.md
...
source_url: https://raw.githubusercontent.com/kubernetes/website/main/content/en/docs/reference/access-authn-authz/rbac.md
upstream_repo_path: content/en/docs/reference/access-authn-authz/rbac.md
upstream_original_path: content/en/docs/reference/access-authn-authz/rbac.md
upstream_ref: main
