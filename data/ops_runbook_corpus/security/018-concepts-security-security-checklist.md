---
doc_id: doc-public-k8s-0018-concepts-security-security-checklist
title: Concepts - Security - Security-Checklist
doc_type: public_doc
status: active
...
- config_violation
language: en
source_path: data/public_corpus/security/018-concepts-security-security-checklist.md
...
source_url: https://raw.githubusercontent.com/kubernetes/website/main/content/en/docs/concepts/security/security-checklist.md
upstream_repo_path: content/en/docs/concepts/security/security-checklist.md
upstream_original_path: content/en/docs/concepts/security/security-checklist.md
upstream_ref: main
