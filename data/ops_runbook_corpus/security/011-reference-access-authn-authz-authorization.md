---
doc_id: doc-public-k8s-0011-do-not-use-the-config-as-is-this-is-an-example
title: DO NOT USE THE CONFIG AS IS. THIS IS AN EXAMPLE.
doc_type: public_doc
status: active
...
- permission_blocked
language: en
source_path: data/public_corpus/security/011-reference-access-authn-authz-authorization.md
...
source_url: https://raw.githubusercontent.com/kubernetes/website/main/content/en/docs/reference/access-authn-authz/authorization.md
upstream_repo_path: content/en/docs/reference/access-authn-authz/authorization.md
upstream_original_path: content/en/docs/reference/access-authn-authz/authorization.md
upstream_ref: main
q3_condition_hint: PERMISSION_BLOCKED
---
