---
doc_id: doc-public-k8s-0008-tasks-configure-pod-container-security-context
title: Tasks - Configure-Pod-Container - Security-Context
doc_type: public_doc
status: active
...
- config_violation
language: en
source_path: data/public_corpus/active/008-tasks-configure-pod-container-security-context.md
...
source_url: https://raw.githubusercontent.com/kubernetes/website/main/content/en/docs/tasks/configure-pod-container/security-context.md
upstream_repo_path: content/en/docs/tasks/configure-pod-container/security-context.md
upstream_original_path: content/en/docs/tasks/configure-pod-container/security-context.md
upstream_ref: main
