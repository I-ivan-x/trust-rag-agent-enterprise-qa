---
doc_id: doc-public-k8s-0020-reference-command-line-tools-reference-feature-g
title: Reference - Command-Line-Tools-Reference - Feature-Gates - Index
doc_type: public_doc
status: active
...
- stale_procedure
language: en
source_path: data/public_corpus/active/020-reference-command-line-tools-reference-feature-gates.md
...
source_url: https://raw.githubusercontent.com/kubernetes/website/main/content/en/docs/reference/command-line-tools-reference/feature-gates/index.md
upstream_repo_path: content/en/docs/reference/command-line-tools-reference/feature-gates/index.md
upstream_original_path: content/en/docs/reference/command-line-tools-reference/feature-gates.md
upstream_ref: main
q3_condition_hint: STALE_PROCEDURE
---
