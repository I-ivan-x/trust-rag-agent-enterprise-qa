---
doc_id: doc-public-k8s-0005-level-is-the-level-to-dry-run-either-baseline-or
title: $LEVEL is the level to dry-run, either "baseline" or "restricted".
doc_type: public_doc
status: active
...
- stale_procedure
language: en
source_path: data/public_corpus/active/005-tasks-configure-pod-container-migrate-from-psp.md
...
source_url: https://raw.githubusercontent.com/kubernetes/website/main/content/en/docs/tasks/configure-pod-container/migrate-from-psp.md
upstream_repo_path: content/en/docs/tasks/configure-pod-container/migrate-from-psp.md
upstream_original_path: content/en/docs/tasks/configure-pod-container/migrate-from-psp.md
upstream_ref: main
