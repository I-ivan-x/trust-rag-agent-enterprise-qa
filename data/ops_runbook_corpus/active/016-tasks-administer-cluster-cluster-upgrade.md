---
doc_id: doc-public-k8s-0016-tasks-administer-cluster-cluster-upgrade
title: Tasks - Administer-Cluster - Cluster-Upgrade
doc_type: public_doc
status: active
...
language: en
source_path: data/public_corpus/active/016-tasks-administer-cluster-cluster-upgrade.md
...
source_url: https://raw.githubusercontent.com/kubernetes/website/main/content/en/docs/tasks/administer-cluster/cluster-upgrade.md
upstream_repo_path: content/en/docs/tasks/administer-cluster/cluster-upgrade.md
upstream_original_path: content/en/docs/tasks/administer-cluster/cluster-upgrade.md
upstream_ref: main
q3_condition_hint: MISSING_PREREQ,ACTIVE_ACTIVE_CONFLICT
---
