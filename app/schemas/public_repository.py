...
class DependencyAudit(BaseModel):
    ...
    npm_moderate_vulnerabilities: Literal[17]
    accepted_moderate_advisory: Literal["GHSA-8988-4f7v-96qf"]
    accepted_advisory_scope: Literal["Lighthouse-only development tooling"]
