...
| [Q5_VALUE_FRONTIER_STRATEGY](docs/Q5_VALUE_FRONTIER_STRATEGY.md) | Q5 core-value plan: step-level cognitive routing, counterfactual value attribution, strong symbolic baseline, and scoped post-freeze demo work |
| [SPEC_Q5_P5_I_VALUE_FRONTIER_HARDENING](docs/SPEC_Q5_P5_I_VALUE_FRONTIER_HARDENING.md) | Zero-request batch for cognitive-step Hybrid routing, a hash-closed value ledger, and a generic symbolic policy control |
