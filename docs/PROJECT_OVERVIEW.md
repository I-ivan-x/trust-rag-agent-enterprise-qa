...
Agent Reliability Lab is a solo-built reliability and evaluation project for enterprise RAG and tool-using agents. **TrustRAG is the legacy codename** preserved in internal identifiers, historical artifacts, run IDs, and tags. The public identity changed; the evidence chain did not.
...
| Q4 | Can a diagnosed selection defect be fixed without relaxing safety or the gate? | Held-out calibrated selection and the governance safety floor were demonstrated within the frozen real-run scope. | `q4.calibrated_selection`, `q4.release_reliability` |
...
- Converted a weak action-selection result into a scoped held-out improvement without changing the safety floor or frozen gate (`q4.calibrated_selection`, `q4.release_reliability`).
...
- Current truth layer: `data/claims/claim_registry.json`, `docs/Q5_CLAIM_MATRIX.md`
- Formal Q5 conclusion: `docs/Q5_FINAL_REPORT.md`
- Boundary interpretation: `docs/Q5_BOUNDARY_A_F_SUMMARY.md`
- Latest results and demos: `docs/LATEST_RESULTS_AND_DEMO.md`
- Full evaluation history: `docs/EVALUATION_REPORT.md`
- Failure taxonomy: `docs/FAILURE_ANALYSIS.md`
- Engineering process: `docs/ENGINEERING_DISCIPLINE.md`
- Exact 180-second demo: `docs/THREE_MINUTE_DEMO_SCRIPT.md`
- Role-specific resume wording: `docs/RESUME_BULLETS.md`
- Archive/maintenance contract: `docs/PROJECT_ARCHIVE_AND_MAINTENANCE.md`
